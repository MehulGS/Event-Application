...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-4xl font-bold mb-8 text-white">Explore Events</h1>
      ...
      <div className="flex flex-wrap justify-between items-center mb-8 p-6 border rounded-lg shadow-lg bg-white">
        ...
        <div className="flex items-center mb-4 sm:mb-0 w-full sm:w-auto">
          <button
            ...
            className="bg-blue-400 text-white px-4 py-2 rounded-md hover:bg-blue-800 transition duration-200"
          >
            Search
          </button>
          <button
            onClick={clearFilters}
            className="bg-blue-800 text-white px-4 py-2 rounded-md hover:bg-blue-400 transition duration-200 ml-4"
          >
            Clear Filters
          </button>
        </div>
